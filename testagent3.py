...
# This delay is required to keep thenewly-hatching agents
# from overwhelming the ClientXMPP class/XMPP server with
# admin traffic. The current setting of 10 seconds is
# arbitrary and could probably be reduced, if necessary.
