...
# This delay is required to keep the
# newly-hatching agents from overwhelming
# the ClientXMPP class/XMPP server with
# admin traffic. The current setting of
# at 10 seconds is arbitrary and could
# probably be reduced, if necessary.
slow_start = 10 #seconds
...
while True:
    try:
        ...
        # The driver script only needs to take care of itself
